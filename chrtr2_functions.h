...
static void chrtr2_get_string (const char *in, char *out)
{
...
static void chrtr2_clean_exit (int32_t ret)
{
  int32_t i;
...
static void chrtr2_sigint_handler (int sig)
{
  chrtr2_clean_exit (-999);
...
static uint8_t              mask[8] = {0x00, 0x80, 0xc0, 0xe0, 0xf0, 0xf8, 0xfc, 0xfe}, notmask[8] = {0xff, 0x7f, 0x3f, 0x1f, 0x0f, 0x07, 0x03, 0x01}; 
...
static void chrtr2_bit_pack (uint8_t buffer[], uint32_t start, uint32_t numbits, int32_t value) 
{ 
...
static uint32_t chrtr2_bit_unpack (uint8_t buffer[], uint32_t start, uint32_t numbits) 
{ 
  int32_t                 start_byte, end_byte, start_bit, end_bit, i;
  uint32_t                value;
...
static char *chrtr2_ngets (char *s, int32_t size, FILE *stream)
{
