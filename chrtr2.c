...
/*!
 ...
 - Arguments:
                ...
                - creating       =    1 if we are creating a new file
...
static void define_record_fields (int32_t hnd, uint8_t creating)
{
  double  range;
  int32_t total_bits;
  ...
  range = (double) (((chrtr2h[hnd].header.max_z - chrtr2h[hnd].header.min_z) + 1.0) * chrtr2h[hnd].header.z_scale);
  ...
  if (chrtr2h[hnd].header.horizontal_uncertainty_scale > 0.0)
    {
      range = (double) ((chrtr2h[hnd].header.max_horizontal_uncertainty - chrtr2h[hnd].header.min_horizontal_uncertainty) *
  ...
  if (chrtr2h[hnd].header.vertical_uncertainty_scale > 0.0)
    {
      range = (double) ((chrtr2h[hnd].header.max_vertical_uncertainty - chrtr2h[hnd].header.min_vertical_uncertainty) *
  ...
  if (chrtr2h[hnd].header.uncertainty_scale > 0.0)
    {
      range = (double) ((chrtr2h[hnd].header.max_uncertainty - chrtr2h[hnd].header.min_uncertainty) * chrtr2h[hnd].header.uncertainty_scale);
  ...
  if (chrtr2h[hnd].header.z0_scale > 0.0)
    {
      range = (double) ((chrtr2h[hnd].header.max_z0 - chrtr2h[hnd].header.min_z0) * chrtr2h[hnd].header.z0_scale);
  ...
  if (chrtr2h[hnd].header.z1_scale > 0.0)
    {
      range = (double) ((chrtr2h[hnd].header.max_z1 - chrtr2h[hnd].header.min_z1) * chrtr2h[hnd].header.z1_scale);
  ...
  if (creating)
    {
      ...
      chrtr2h[hnd].record_size = (double) total_bits / 8.0;
...
static int32_t pack_record (int32_t hnd, uint8_t *buffer, CHRTR2_RECORD chrtr2_record)
{
  int32_t value32;
...
static void unpack_record (int32_t hnd, uint8_t *buffer, CHRTR2_RECORD *chrtr2_record)
{
  int32_t value32;
  ...
  chrtr2_record->z = ((float) value32 / chrtr2h[hnd].header.z_scale) + chrtr2h[hnd].header.min_z;
  ...
  if (chrtr2h[hnd].h_uncert_bits)
    {
      ...
      chrtr2_record->horizontal_uncertainty = ((float) value32 / chrtr2h[hnd].header.horizontal_uncertainty_scale) +
  ...
  if (chrtr2h[hnd].v_uncert_bits)
    {
      ...
      chrtr2_record->vertical_uncertainty = ((float) value32 / chrtr2h[hnd].header.vertical_uncertainty_scale) +
  ...
  if (chrtr2h[hnd].uncert_bits)
    {
      ...
      chrtr2_record->uncertainty = ((float) value32 / chrtr2h[hnd].header.uncertainty_scale) + chrtr2h[hnd].header.min_uncertainty;
    }
  ...
  if (chrtr2h[hnd].z0_bits)
    {
      ...
      chrtr2_record->z0 = ((float) value32 / chrtr2h[hnd].header.z0_scale) + chrtr2h[hnd].header.min_z0;
    }
  ...
  if (chrtr2h[hnd].z1_bits)
    {
      ...
      chrtr2_record->z1 = ((float) value32 / chrtr2h[hnd].header.z1_scale) + chrtr2h[hnd].header.min_z1;
    }
...
static int32_t chrtr2_write_header (int32_t hnd)
{
  char space = ' ';
...
CHRTR2_DLL int32_t chrtr2_create_file (const char *path, CHRTR2_HEADER *chrtr2_header)
{
  ...
  if (first)
    {
      ...
      signal (SIGINT, chrtr2_sigint_handler);
  ...
  chrtr2h[hnd].max_status = NINT (pow (2.0, (double) chrtr2h[hnd].status_bits)) - 1;
  ...
  /*SJ - since we went to grid registration the N and E colums/rows are inclusive and N and E need to comeback*/

  chrtr2_header->mbr.elon = chrtr2_header->mbr.wlon + (double) (chrtr2_header->width-1) * chrtr2_header->lon_grid_size_degrees;
  chrtr2_header->mbr.nlat = chrtr2_header->mbr.slat + (double) (chrtr2_header->height-1) * chrtr2_header->lat_grid_size_degrees;
  ...
  chrtr2h[hnd].modified = 1;
  chrtr2h[hnd].created = 1;
...
{
  int32_t i, hnd, year[4], jday[4], hour[4], minute[4];
  float second[4], tmpf;
  ...
  while (chrtr2_ngets (varin, sizeof (varin), chrtr2h[hnd].fp))
    {
      ...
      if (strstr (varin, "[VERSION]"))
        {
          ...
          chrtr2h[hnd].major_version = (int16_t) tmpf;

          strcpy (info, strstr (CHRTR2_VERSION, N_("library V")));
          sscanf (info, N_("library V%f"), &tmpf);
          if (chrtr2h[hnd].major_version > (int16_t) tmpf)
            {
              strcpy (chrtr2_error.file, chrtr2h[hnd].path);
      ...
      if (strstr (varin, N_("[Z UNITS]")))
        {
          if (strstr (info, "METERS"))
            {
              chrtr2h[hnd].header.z_units = CHRTR2_METERS;
            }
          else if (strstr (info, "FEET"))
            {
              chrtr2h[hnd].header.z_units = CHRTR2_FEET;
            }
          else if (strstr (info, "FATHOMS"))
            {
              chrtr2h[hnd].header.z_units = CHRTR2_FATHOMS;
            }
          else
            {
              sscanf (info, "%hd", &tmpi16);
              chrtr2h[hnd].header.z_units = (uint8_t) tmpi16;
            }
        }
      ...
      if (strstr (varin, N_("[STATUS BITS]")))
        {
          sscanf (info, "%hd", &tmpi16);
          chrtr2h[hnd].status_bits = (uint8_t) tmpi16;
        }
  ...
  define_record_fields (hnd, 0);

  *chrtr2_header = chrtr2h[hnd].header;

  chrtr2h[hnd].modified = 0;
  chrtr2h[hnd].created = 0;
...
CHRTR2_DLL int32_t chrtr2_read_record (int32_t hnd, NV_I32_COORD2 coord, CHRTR2_RECORD *chrtr2_record)
{
  ...
  pos = (int64_t) chrtr2h[hnd].header_size + (((int64_t) coord.y * (int64_t) chrtr2h[hnd].header.width) + (int64_t) coord.x) *
    (int64_t) chrtr2h[hnd].record_size;
...
CHRTR2_DLL int32_t chrtr2_read_record_lat_lon (int32_t hnd, double lat, double lon, CHRTR2_RECORD *chrtr2_record)
{
  ...
  coord.x = (int32_t) ((lon - chrtr2h[hnd].header.mbr.wlon) / chrtr2h[hnd].header.lon_grid_size_degrees);
  coord.y = (int32_t) ((lat - chrtr2h[hnd].header.mbr.slat) / chrtr2h[hnd].header.lat_grid_size_degrees);
...
CHRTR2_DLL int32_t chrtr2_read_row (int32_t hnd, int32_t row, int32_t start_column, int32_t length, CHRTR2_RECORD *chrtr2_record)
{
  int64_t pos;
  uint8_t *buffer = NULL, *ptr;
  int32_t i, bytes;
  ...
  pos = (int64_t) chrtr2h[hnd].header_size + (((int64_t) row * (int64_t) chrtr2h[hnd].header.width) + (int64_t) start_column) *
    (int64_t) chrtr2h[hnd].record_size;
...
CHRTR2_DLL int32_t chrtr2_write_record (int32_t hnd, NV_I32_COORD2 coord, CHRTR2_RECORD chrtr2_record)
{
  ...
  /* SJ- 05/18/2013 - added catch for value issue between 32bit and 64bit files when using CHRTR2_NULL_Z_VALUE as the maximum uncertainty value*/

  if(chrtr2_record.uncertainty > chrtr2h[hnd].header.max_uncertainty && chrtr2_record.uncertainty > CHRTR2_NULL_Z_VALUE)
    {
      chrtr2_record.uncertainty=CHRTR2_NULL_Z_VALUE;
    }


  /* SJ- 06/24/2013 - We have to account for the lower bound incase the minum uncertainty was set incorrectly*/	

  if(chrtr2_record.uncertainty < chrtr2h[hnd].header.min_uncertainty && chrtr2_record.uncertainty < CHRTR2_NULL_Z_VALUE)
    {
      chrtr2_record.uncertainty=CHRTR2_NULL_Z_VALUE;
    }
...
CHRTR2_DLL int32_t chrtr2_write_row (int32_t hnd, int32_t row, int32_t start_col, int32_t length, CHRTR2_RECORD *chrtr2_record)
{
  ...
  pos = (int64_t) chrtr2h[hnd].header_size + (((int64_t) row * (int64_t) chrtr2h[hnd].header.width) + (int64_t) start_col) *
    (int64_t) chrtr2h[hnd].record_size;
...
CHRTR2_DLL int32_t chrtr2_open_cov_map (int32_t hnd)
{
  ...
  chrtr2h[hnd].cov_map = (uint8_t *) calloc (size, sizeof (uint8_t));
...
CHRTR2_DLL int32_t chrtr2_get_coord (int32_t hnd, double lat, double lon, NV_I32_COORD2 *coord)
{
  ...
  coord->x = (int32_t) floor(((lon - chrtr2h[hnd].header.mbr.wlon) / chrtr2h[hnd].header.lon_grid_size_degrees)+.5);
  coord->y = (int32_t) floor(((lat - chrtr2h[hnd].header.mbr.slat) / chrtr2h[hnd].header.lat_grid_size_degrees)+.5);
...
CHRTR2_DLL int32_t chrtr2_get_lat_lon (int32_t hnd, double *lat, double *lon, NV_I32_COORD2 coord)
{
  ...
  /*are are no longer doing the half-node thing, so (double) coord.x + 0.5L was removed from calculation  - SJ*/

  *lon = chrtr2h[hnd].header.mbr.wlon + (double) coord.x * chrtr2h[hnd].header.lon_grid_size_degrees;
  *lat = chrtr2h[hnd].header.mbr.slat + (double) coord.y * chrtr2h[hnd].header.lat_grid_size_degrees;
...
{
  fprintf (stderr, "%s", chrtr2_strerror ());
  fflush (stderr);
}
...
CHRTR2_DLL void chrtr2_cvtime (time_t tv_sec, long tv_nsec, int32_t *year, int32_t *jday, int32_t *hour,
...
CHRTR2_DLL void chrtr2_inv_cvtime (int32_t year, int32_t jday, int32_t hour, int32_t min, float sec,
...
/*!
  ...
  - Function:    chrtr2_setStatus

  - Purpose:     Set the chrtr2 record status.  Since there is both a status and a mask,
                 this function just makes the whole thing easier

  - Author:      Stacy Johnson

  - Arguments:
                 - rec            =  Pointer to chrtr2 record
                 - status         =  Status you want to set.

  - Returns:
                 - Bool           = success/failure

  - Caveats:     If status is CHRTR2_REAL, CHRTR2_INTERPOLATED or CHRTR2_DIGITIZED_CONTOUR
                 are mutually exclusive so apply the associated mask.  If the status is any
                 other, do not remove previous status.
...
CHRTR2_DLL uint8_t chrtr2_setStatus(CHRTR2_RECORD * rec, int32_t status)
{
  switch (status)
    {
    case 0:
      /*A status of CHRTR2_NULL requires a full wipe of the record*/
      memset (rec, 0, sizeof (CHRTR2_RECORD));
      break;

    case 1:
      rec->status=(rec->status & CHRTR2_REAL_MASK) | CHRTR2_REAL;
      break;

    case 2:
      rec->status=(rec->status & CHRTR2_INTERPOLATED_MASK) | CHRTR2_INTERPOLATED;
      break;

    case 4:
      rec->status=(rec->status & CHRTR2_DIGITIZED_MASK) | CHRTR2_DIGITIZED_CONTOUR;
      break;

    case 8:
      rec->status=rec->status | CHRTR2_CHECKED;
      break;

    case 16:
      rec->status=rec->status | CHRTR2_USER_01;
      break;

    case 32:
      rec->status=rec->status | CHRTR2_USER_02;
      break;

    case 64:
      rec->status=rec->status | CHRTR2_USER_03;
      break;

    case 128:
      rec->status=rec->status | CHRTR2_USER_04;
      break;

    case 256:
      rec->status=rec->status | CHRTR2_LAND_MASK;
      break;

    case 512:
      rec->status=rec->status | CHRTR2_SPARE1;
      break;

    case 1024:
      rec->status=rec->status | CHRTR2_SPARE2;
      break;

    case 2048:
      rec->status=rec->status | CHRTR2_SPARE3;
      break;

    case 496:
      rec->status=rec->status | CHRTR2_USER;
      break;
...
/*!
  ...
  - Function:    chrtr2_checkStatus

  - Purpose:     Check a chrtr2 record for a given status

  - Author:      Stacy Johnson

  - Arguments:
                 - rec           =   pointer to a chrtr2 record
  ...
  - Caveats:     User can check for multiple status by "oring {|}" to status together to pass to this function

  - Example:     chrtr2_getStatus(&rec,(CHRTR2_REAL | CHRTR2_DIGITIZED_CONTOUR));
...
/*!
  ...
  - Function:    chrtr2_isLand

  - Purpose:     returns wether the chrtr2 record is land masked
  ...
  - Caveats:     can be replaced by a call to chrtr2_checkStatus

*********************************************************************************************/

CHRTR2_DLL uint8_t chrtr2_isLand(CHRTR2_RECORD rec)
{
  return chrtr2_checkStatus(rec,CHRTR2_LAND_MASK);
}
...
/*!
  ...
  - Function:    chrtr2_checked

  - Purpose:     Flip the checked status of a chrtr2 record.
 ...
 - Returns:
  ...
  - Caveats:     Does not test any other status
